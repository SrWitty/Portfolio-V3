            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-6 text-center">
                        <a href="https://discord.com/users/1091118468155314306" className="text-dark mb-4 icon-link animate__animated animate__fadeInLeft" style={{ marginRight: '20px' }}> {/* Added animation classes */}
                            <i className="fab fa-discord" style={{ fontSize: '3.5rem' }}></i> {/* Decreased icon size */}
                        </a>
                        <a href="https://twitter.com/iim7md11_" className="text-dark mb-4 icon-link animate__animated animate__fadeInUp" style={{ marginRight: '20px' }}> {/* Added animation classes */}
                            <i className="fab fa-xing-square" style={{ fontSize: '3.5rem' }}></i> {/* Decreased icon size */}
                        </a>
                        <a href="https://github.com/iim7md11" className="text-dark mb-4 icon-link animate__animated animate__fadeInRight" style={{ marginRight: '20px' }}> {/* Added animation classes */}
